...
SEXP ribex_c_session_infer_schema(SEXP session_sexp, SEXP query_sexp, SEXP lexical_names_sexp);
...
static const R_CallMethodDef call_methods[] = {
    ...
    {"ribex_c_session_infer_schema", (DL_FUNC)&ribex_c_session_infer_schema, 3},
