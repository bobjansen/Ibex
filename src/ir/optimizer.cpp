...
auto make_default_pass_manager() -> PassManager {
    ...
    // Predicate pushdown: disabled because the implementation doesn't match
    // the actual IR structures generated by the lowerer. Moving it before/after
    // canonicalize doesn't help. The architecture needs rethinking.
