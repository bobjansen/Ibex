...
// `morsel_grain`). Window/rank evaluation is in rank_window.cpp; extern-call
// execution in extern_call.cpp. Split out of interpreter.cpp; shared
// declarations live in interpreter_internal.hpp.
